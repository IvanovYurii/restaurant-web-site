...
public class ShoppingCartController {
    ...
    @Operation(
            ...
            description = "Retrieve the shopping cart for the authenticated user. "
                    ...
                    + "about the user's shopping cart, including cart items with product details, "
    ...
    @Operation(
            ...
            description = "Add a product to the user's shopping cart. "
                    ...
                    + "details about the added cart item, such as cart item ID, product details,"
    ...
    public CartItemDto updateCartItemQuantity(
            ...
            @RequestBody @Valid UpdateCartItemQuantityProductRequestDto requestDto
    ) {
        User user = (User) authentication.getPrincipal();
    ...
    public void deleteBookFromShoppingCart(
        ...
        User user = (User) authentication.getPrincipal();
        shoppingCartService.deleteProductFromShoppingCart(user, cartItemId);
    }
}
